export const LayoutSidebarInsetReverse = `<svg class="bi bi-layout-sidebar-inset-reverse"  viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
