export const Calendar2MinusFill = `<svg class="bi bi-calendar2-minus-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
