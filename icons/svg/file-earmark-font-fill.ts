export const FileEarmarkFontFill = `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="currentColor" class="bi bi-file-earmark-font-fill" viewBox="0 0 16 16">
