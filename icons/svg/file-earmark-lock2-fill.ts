export const FileEarmarkLock2Fill = `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="currentColor" class="bi bi-file-earmark-lock2-fill" viewBox="0 0 16 16">
