export const SkipForwardBtnFill = `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="currentColor" class="bi bi-skip-forward-btn-fill" viewBox="0 0 16 16">
