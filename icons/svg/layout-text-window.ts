export const LayoutTextWindow = `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="currentColor" class="bi bi-layout-text-window" viewBox="0 0 16 16">
