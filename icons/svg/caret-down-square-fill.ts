export const CaretDownSquareFill = `<svg class="bi bi-caret-down-square-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
