export const Calendar3WeekFill = `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="currentColor" class="bi bi-calendar3-week-fill" viewBox="0 0 16 16">
